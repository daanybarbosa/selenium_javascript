...
//ele recebe dois argumentos: 1 - title, 2 function 
describe("add todo tests", function () {

    //Adicionando o Mocha - it block
    //usa a mesma sintaxe do describe, porem usamos uma funcao assincrona, pq estaremos executando alguns codigos assincronos
    it("successfully adds a todo to application", async function () {

        //async function example(){ //no Mocha nao é preciso usar a funçao example() 
